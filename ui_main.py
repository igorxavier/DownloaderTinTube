...
"}")
        ...
        self.widget_2 = QWidget(self.qlin1_2)
        self.widget_2.setObjectName(u"widget_2")
        self.widget_2.setMinimumSize(QSize(0, 0))
        self.horizontalLayout_2 = QHBoxLayout(self.widget_2)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.lbl_titulo = QLabel(self.widget_2)
        self.lbl_titulo.setObjectName(u"lbl_titulo")
        sizePolicy1 = QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.lbl_titulo.sizePolicy().hasHeightForWidth())
        self.lbl_titulo.setSizePolicy(sizePolicy1)
        font = QFont()
        font.setPointSize(23)
        self.lbl_titulo.setFont(font)
        self.lbl_titulo.setStyleSheet(u"color: rgb(85, 170, 127);")

        self.horizontalLayout_2.addWidget(self.lbl_titulo)

        self.lbl_versao = QLabel(self.widget_2)
        self.lbl_versao.setObjectName(u"lbl_versao")
        sizePolicy2 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.lbl_versao.sizePolicy().hasHeightForWidth())
        self.lbl_versao.setSizePolicy(sizePolicy2)
        self.lbl_versao.setMinimumSize(QSize(0, 20))
        self.lbl_versao.setMaximumSize(QSize(16777215, 20))
        self.lbl_versao.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.horizontalLayout_2.addWidget(self.lbl_versao)
...
"}")
        ...
        sizePolicy3.setHeightForWidth(self.edit_local.sizePolicy().hasHeightForWidth())
        self.edit_local.setSizePolicy(sizePolicy3)
...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.list_links.sizePolicy().hasHeightForWidth())
        self.list_links.setSizePolicy(sizePolicy4)
        self.list_links.setMinimumSize(QSize(0, 0))
        self.list_links.setMaximumSize(QSize(16777215, 16777215))
        palette1 = QPalette()
        brush10 = QBrush(QColor(200, 200, 200, 255))
        brush10.setStyle(Qt.SolidPattern)
        palette1.setBrush(QPalette.Active, QPalette.Button, brush10)
        brush11 = QBrush(QColor(52, 52, 52, 255))
        ...
        brush12 = QBrush(QColor(77, 90, 0, 255))
        brush12.setStyle(Qt.SolidPattern)
        palette1.setBrush(QPalette.Active, QPalette.Link, brush12)
        ...
        brush13 = QBrush(QColor(77, 91, 0, 255))
        ...
        brush14 = QBrush(QColor(58, 75, 0, 255))
        brush14.setStyle(Qt.SolidPattern)
        palette1.setBrush(QPalette.Disabled, QPalette.Link, brush14)
        ...
        sizePolicy5.setHeightForWidth(self.pro_bar.sizePolicy().hasHeightForWidth())
        self.pro_bar.setSizePolicy(sizePolicy5)
        ...
        palette2 = QPalette()
        brush15 = QBrush(QColor(64, 64, 64, 255))
        ...
        brush16 = QBrush(QColor(64, 64, 64, 128))
...
"color: rgb(64, 64, 64);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_versao.setText(QCoreApplication.translate("MainWindow", u"0.0.1", None))

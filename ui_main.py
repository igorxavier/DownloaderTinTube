...
"}")
        ...
        brush7 = QBrush(QColor(52, 52, 52, 255))
        ...
        brush8 = QBrush(QColor(77, 90, 0, 255))
        ...
        brush9 = QBrush(QColor(77, 91, 0, 255))
        ...
        brush10 = QBrush(QColor(58, 75, 0, 255))
        ...
        brush12 = QBrush(QColor(85, 170, 127, 255))
        ...
        palette2.setBrush(QPalette.Disabled, QPalette.Link, brush14)
#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 0)
